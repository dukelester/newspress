...
@pytest.mark.parametrize(('username', 'phone', 'email', 'fullname', 'password'),
   (('', '073458922', 'duketest@gmail.com',  'duke tester', 'duketest2030',  b'Username is required'),
    ('duketester', '073458922', 'duketest@gmail.com',  'duke tester', '', b'Password is required'),
    ('duketester', '', 'duketest@gmail.com',  'duke tester', 'duketest2030', b'Phone number is required'),
    ('duketester', '073458922', '',  'duke tester', 'duketest2030', b'Email is required'),
    ('duketester', '073458922', 'duketest@gmail.com',  '', 'duketest2030', b'Full Name is required'),
    ))
